...
let
  src = fetchFromGitHub {
    owner = "katursis"; repo = "Pawn.CMD";
    rev = "091ffee953c7350c2b327c3a0f07c92f7f1a45ae";
    hash = "sha256-sTrv440WdEu9B456xu3gaXTKzltX3jFr185uWQpXUOo=";
  };
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    runHook postInstall
  '';
  meta.description = "Pawn.CMD plugin for SA-MP/open.mp";
}
